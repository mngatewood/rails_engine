...
describe "Merchants revenue API" do
  ...
  it "should return the total revenue for date across all merchants" do
    ...
    invoice_item_1 = create(:invoice_item, quantity: 1, unit_price: 100, invoice_id: invoice_1.id, item_id: item_1.id)
    invoice_item_2 = create(:invoice_item, quantity: 100, unit_price: 100, invoice_id: invoice_2.id, item_id: item_1.id)
    invoice_item_3 = create(:invoice_item, quantity: 1, unit_price: 100, invoice_id: invoice_3.id, item_id: item_2.id)
    invoice_item_4 = create(:invoice_item, quantity: 1, unit_price: 10000, invoice_id: invoice_4.id, item_id: item_2.id)
    invoice_item_5 = create(:invoice_item, quantity: 1, unit_price: 100, invoice_id: invoice_5.id, item_id: item_3.id)
    invoice_item_6 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_6.id, item_id: item_3.id)
    invoice_item_7 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_7.id, item_id: item_3.id)
    ...
    expect(revenue["attributes"]["revenue"]).to eq("3.0")
  end
  ...
  it "should return the total revenue for that merchant across successful transactions" do
    ...
    invoice_item_1 = create(:invoice_item, quantity: 1, unit_price: 143, invoice_id: invoice_1.id, item_id: item_1.id)
    invoice_item_2 = create(:invoice_item, quantity: 5, unit_price: 112, invoice_id: invoice_2.id, item_id: item_1.id)
    invoice_item_3 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_3.id, item_id: item_2.id)
    invoice_item_4 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_4.id, item_id: item_2.id)
    transaction_1 = create(:transaction, invoice_id: invoice_1.id)
    transaction_2 = create(:transaction, invoice_id: invoice_2.id)
    ...
    revenue = JSON.parse(response.body)["data"]
    expect(response).to be_successful
    expect(revenue["attributes"]["revenue"]).to eq("7.03")
  end
  ...
  it "should return the total revenue for that merchant for a specific invoice date" do
    ...
    invoice_item_1 = create(:invoice_item, quantity: 1, unit_price: 115, invoice_id: invoice_1.id, item_id: item_1.id)
    invoice_item_2 = create(:invoice_item, quantity: 100, unit_price: 100, invoice_id: invoice_2.id, item_id: item_1.id)
    invoice_item_3 = create(:invoice_item, quantity: 1, unit_price: 133, invoice_id: invoice_3.id, item_id: item_1.id)
    invoice_item_4 = create(:invoice_item, quantity: 2, unit_price: 10000, invoice_id: invoice_4.id, item_id: item_1.id)
    invoice_item_5 = create(:invoice_item, quantity: 1, unit_price: 149, invoice_id: invoice_5.id, item_id: item_1.id)
    invoice_item_6 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_6.id, item_id: item_2.id)
    invoice_item_7 = create(:invoice_item, quantity: 100, unit_price: 10000, invoice_id: invoice_7.id, item_id: item_1.id)
    transaction_1 = create(:transaction, invoice_id: invoice_1.id)
    transaction_2 = create(:transaction, invoice_id: invoice_2.id)
    transaction_3 = create(:transaction, invoice_id: invoice_3.id)
    transaction_4 = create(:transaction, invoice_id: invoice_4.id)
    ...
    revenue = JSON.parse(response.body)["data"]
    expect(response).to be_successful
    expect(revenue["attributes"]["revenue"]).to eq("3.97")
  end
